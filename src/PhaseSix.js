                ...
                {({ errors, touched }) => (
                    <Form>
                        <div className='grid grid-cols-2 md:grid-cols-4 gap-4 p-4' >
                            ...
                            <div className='grid grid-cols-1' >
                                <Field className='border-2 border-sky-500 rounded-lg h-10 p-2.5' id='lot' name='lot' placeholder='Lotto materia prima' />
                            ...
                            <div className='grid grid-cols-1' >
                                <Field className='border-2 border-sky-500 rounded-lg h-10 p-2.5' id='product' name='product' placeholder='Prodotto' />
                            ...
                            <div className='grid grid-cols-1' >
                                <Field className='border-2 border-sky-500 rounded-lg h-10 p-2.5' id='productLot' name='productLot' placeholder='Lotto prodotto' />
                            ...
                            {insertedValues.map((value, index) => {
                                return (
                                    <tr key={index} className={index % 2 === 0 ? 'bg-sky-100 border-b border-gray-200' : 'border-b border-gray-200 bg-sky-200'}>
                                        ...
                                        <td className="py-3 px-6">
                                            <div className="flex justify-center items-center">
                                                <span className="font-bold text-sky-700">{value.product}</span>
                                            </div>
                                        </td>
                                        <td className="py-3 px-6">
                                            <div className="flex justify-center items-center">
                                        ...
                                        <td className="py-3 px-6">
                                            <div className="flex justify-center items-center">
                                                <span className="font-bold text-sky-700">{value.productLot}</span>
                                            </div>
                                        </td>
                                        <td className="py-3 px-6">
                                            <div className="flex justify-center items-center">
