                    ...
                    <Form>
                        <div className='grid grid-cols-2 md:grid-cols-4 gap-4 p-4' >
                            ...
                            <div className='grid grid-cols-1' >
                                <Field className='border-2 border-sky-500 rounded-lg h-10 p-2.5' id='plants' name='plants' placeholder="Piante o semi" />
                            ...
                            <Field type="checkbox" className='border-sky-500 text-sky-600 bg-gray-100 form-checkbox focus:ring-sky-500 rounded-lg h-10 w-10' id='isCompliant' name='isCompliant' />
                            
                            <label htmlFor='kg'>
                                Kg o colli acquistati
                            </label>
                            <div className='grid grid-cols-1' >
                                <Field type='number' className='text-sm rounded-lg focus:ring-sky-500 block w-full p-2.5 border-2 border-sky-500 rounded-lg h-10' id='kg' name='kg' />
                                    ...
                                    <tr key={index} className={index % 2 === 0 ? 'bg-sky-100 border-b border-gray-200' : 'border-b border-gray-200 bg-sky-200'}>
                                        <td className="py-3 px-6">
                                            <div className="flex justify-center items-center">
                                                <span className="font-bold text-sky-700">{value.plants}</span>
                                            </div>
                                        </td>
                                        <td className="py-3 px-6">
                                            <div className="flex justify-center items-center">
                                        ...
                                        <td className="py-3 px-6">
                                            <div className="flex justify-center items-center">
                                                <span className="font-bold text-sky-700">{value.isCompliant ? 'Si' : 'No'}</span>
                                            </div>
                                        </td>
                                        <td className="py-3 px-6">
                                            <div className="flex justify-center items-center">
                                                <span className="font-bold text-sky-700">{value.kg}</span>
                                            </div>
                                        </td>
                                        <td className="py-3 px-6">
                                            <div className="flex justify-center items-center">
