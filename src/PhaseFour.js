                    ...
                    <Form>
                        <div className='grid grid-cols-2 md:grid-cols-4 gap-4 p-4' >
                            ...
                            <div className="relative">
                                ...
                                <Field disabled={!productEditable} className='bg-green-50 border border-green-300 text-green-900 sm:text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full md:pl-10 sm:pl-1 p-2.5' id='date' name='date' type='date' />
                            </div>
                            <label htmlFor='name'>
                                Tipo di prodotto
                            </label>
                            ...
                            <div className="relative">
                                ...
                                <Field className='bg-green-50 border border-green-300 text-green-900 sm:text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full md:pl-10 sm:pl-1 p-2.5' id='expirationDate' name='expirationDate' type='date' disabled={!productEditable} />
                            </div>
